package org.ferris.sushi.endpoint.event.consumer;
...
import org.ferris.sushi.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("org.ferris.sushi.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "org.ferris.sushi.service.event."
